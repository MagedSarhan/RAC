...
const PRODUCTS = [
  {
    id: 1, name: 'طقم هدايا دعائية فاخر', price: 45, image: 'image/cat-giveaways.png',
    category: 'giveaways', catLabel: 'هدايا دعائية', badge: 'الأكثر مبيعاً', badgeColor: '',
    time: '٢٤ ساعة', customFields: []
  },
  {
    id: 2, name: 'معلقة سيارة محفورة بالاسم', price: 35, image: 'image/cat-car-hangers.png',
    category: 'car-hangers', catLabel: 'معلقات سيارات', badge: '', badgeColor: '',
    time: '٤٨ ساعة',
    customFields: [{ label: 'الاسم المراد حفره', type: 'text', required: true }]
  },
  {
    id: 3, name: 'ستيكر جوال بتصميم خاص', price: 25, image: 'image/hero-1.png',
    category: 'stickers', catLabel: 'ستيكرات أجهزة', badge: 'جديد', badgeColor: 'var(--alamah-gold)',
    time: '٢٤ ساعة',
    customFields: [{ label: 'وصف التصميم المطلوب', type: 'textarea', required: true }]
  },
  {
    id: 4, name: 'لوحة خشبية محفورة بالليزر', price: 65, image: 'image/hero-3.png',
    category: 'laser', catLabel: 'حفر بالليزر', badge: '', badgeColor: '',
    time: '٣ أيام',
    customFields: [
      { label: 'النص المراد حفره', type: 'text', required: true },
      { label: 'ملاحظات إضافية', type: 'textarea', required: false }
    ]
  },
  {
    id: 5, name: 'بوكس هدية مناسبات', price: 85, image: 'image/hero-2.png',
    category: 'occasions', catLabel: 'مناسبات', badge: 'مميز', badgeColor: 'var(--alamah-gold)',
    time: '٣ أيام',
    customFields: [{ label: 'اسم المهدى إليه', type: 'text', required: false }]
  },
  {
    id: 6, name: 'طقم أقلام محفورة', price: 55, image: 'image/cat-giveaways.png',
    category: 'giveaways', catLabel: 'هدايا دعائية', badge: '', badgeColor: '',
    time: '٤٨ ساعة',
    customFields: [{ label: 'الاسم أو الشعار المراد حفره', type: 'text', required: true }]
  },
  {
    id: 7, name: 'معلقة سيارة كريستال', price: 50, image: 'image/cat-car-hangers.png',
    category: 'car-hangers', catLabel: 'معلقات سيارات', badge: '', badgeColor: '',
    time: '٣ أيام',
    customFields: [{ label: 'الاسم المراد حفره', type: 'text', required: true }]
  },
  {
    id: 8, name: 'تصميم خاص حسب الطلب', price: 120, image: 'image/custom-order-banner.png',
    category: 'custom', catLabel: 'طلبات خاصة', badge: 'حسب الطلب', badgeColor: '#1B2A5B',
    time: 'يُحدد لاحقاً',
    customFields: [
      { label: 'وصف الطلب بالتفصيل', type: 'textarea', required: true },
      { label: 'الكمية المطلوبة', type: 'text', required: true }
    ]
  },
  {
    id: 9, name: 'ميدالية مفاتيح محفورة', price: 20, image: 'image/hero-1.png',
    category: 'laser', catLabel: 'حفر بالليزر', badge: '', badgeColor: '',
    time: '٢٤ ساعة',
    customFields: [{ label: 'الاسم المراد حفره', type: 'text', required: true }]
  },
  {
    id: 10, name: 'ستيكر لابتوب مخصص', price: 30, image: 'image/hero-2.png',
    category: 'stickers', catLabel: 'ستيكرات أجهزة', badge: '', badgeColor: '',
    time: '٢٤ ساعة',
    customFields: [{ label: 'وصف التصميم', type: 'textarea', required: false }]
  },
  {
    id: 11, name: 'بوكس تخرج فاخر', price: 95, image: 'image/hero-3.png',
    category: 'occasions', catLabel: 'مناسبات', badge: '', badgeColor: '',
    time: '٣ أيام',
    customFields: [{ label: 'اسم الخريج/ة', type: 'text', required: true }]
  },
  {
    id: 12, name: 'طقم هدايا شركات', price: 150, image: 'image/cat-giveaways.png',
    category: 'giveaways', catLabel: 'هدايا دعائية', badge: 'للشركات', badgeColor: '#1B2A5B',
    time: '٥ أيام',
    customFields: [
      { label: 'اسم الشركة', type: 'text', required: true },
      { label: 'الكمية', type: 'text', required: true }
    ]
  }
];
...
const FEATURED_PRODUCTS = [
  {
    id: 101,
    name: 'كاميرا Insta360 GO 3S',
    desc: 'كاميرا صغيرة بدقة عالية مع ملحقات تصوير يومية.',
    price: 1290,
    oldPrice: 1490,
  ...
  {
    id: 102,
    name: 'حامل MagSafe أزرق للجوال',
    desc: 'حافظة وحامل مغناطيسي عملي للجوال والأجهزة اللوحية.',
    price: 89,
    oldPrice: 119,
  ...
  {
    id: 103,
    name: 'آلة قهوة ذكية XBloom',
    desc: 'تحضير قهوة دقيق بتصميم مكتبي أنيق وسهل الاستخدام.',
    price: 2390,
    oldPrice: 2590,
  ...
  {
    id: 104,
    name: 'خلاط بروتين محمول PORODO',
    desc: 'كوب خلط كهربائي محمول للرياضة والاستخدام اليومي.',
    price: 149,
    oldPrice: 179,
  ...
  },
  {
    ...
    desc: 'صوت محيطي مريح مع تصميم عملي للاستخدام الطويل.',
    price: 349,
    oldPrice: 429,
  ...
  {
    id: 106,
    name: 'كاميرا مراقبة داخلية IMOU',
    desc: 'تصوير واضح ومتابعة ذكية للمنزل أو المكتب.',
    price: 199,
    oldPrice: 249,
  ...
  {
    id: 107,
    name: 'كاميرا DJI Osmo Pocket 4',
    desc: 'تصوير ثابت ومناسب للمحتوى والسفر بجودة عالية.',
    price: 2990,
    oldPrice: null,
  ...
  {
    id: 108,
    name: 'سماعة Type-C سلكية',
    desc: 'سماعة عملية بمنفذ تايب سي وصوت واضح للاستخدام اليومي.',
    price: 58,
    oldPrice: null,
  ...
  },
  {
    id: 109,
    name: 'جهاز iPad Air',
    desc: 'شاشة واسعة وأداء سريع للعمل والترفيه.',
    price: 2490,
    oldPrice: 2690,
    image: 'image/products/product 9.jpg',
    category: 'screens',
    catLabel: 'أجهزة لوحية',
    badge: 'مميز',
    customFields: []
  },
  {
    id: 110,
    name: 'هاتف iPhone 17',
    desc: 'تصميم أنيق وأداء قوي مع شاشة عالية الوضوح.',
    price: 3150,
    oldPrice: null,
...
const NEW_PRODUCTS = [
  {
    id: 201,
    name: 'ماكينة حلاقة لاسلكية احترافية',
    desc: 'تعمل بالبطارية مع شاشة رقمية للاستخدام اليومي.',
    price: 79,
    oldPrice: null,
    image: 'image/new products/new 1.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'جديد',
    customFields: []
  ...
  {
    id: 202,
    name: 'ماكينة حلاقة Moxedo Orvex',
    desc: 'قطعتان لاسلكية بشاشة LCD وتصميم عملي.',
    price: 79,
    oldPrice: null,
    image: 'image/new products/new 2.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'جديد',
    customFields: []
  ...
  {
    id: 203,
    name: 'شنطة Spigen Klasden KD300',
    desc: 'شنطة تدعم حتى 16 إنش ومناسبة للعمل والسفر.',
    price: 269,
    oldPrice: null,
    image: 'image/new products/new 3.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'جديد',
    customFields: []
  ...
  {
    id: 204,
    name: 'شنطة جوال Crossbody من Spigen',
    desc: 'حجم 6.8 إنش مع سير قابل للتعديل.',
    price: 189,
    oldPrice: null,
    image: 'image/new products/new 4.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'جديد',
    customFields: []
  ...
  {
    id: 205,
    name: 'سماعة JBL GO 4 متنقلة',
    desc: 'لاسلكية مقاومة للماء بصوت عالي وتصميم مدمج.',
    price: 169,
    oldPrice: null,
    image: 'image/new products/new 5.jpg',
    category: 'audio',
    catLabel: 'صوتيات',
    badge: 'جديد',
    customFields: []
  ...
  {
    id: 206,
    name: 'سماعة JBL Flip 6 متنقلة',
    desc: 'تعمل بالبطارية ومقاومة للماء بصوت قوي.',
    price: 399,
    oldPrice: null,
    image: 'image/new products/new 6.jpg',
    category: 'audio',
    catLabel: 'صوتيات',
    badge: 'جديد',
    customFields: []
  ...
  {
    id: 207,
    name: 'بروجكتر ذكي محمول',
    desc: 'عرض واضح للمكتب والمنزل مع تشغيل سهل.',
    price: 899,
    oldPrice: null,
    image: 'image/new products/new 7.jpg',
    category: 'screens',
    catLabel: 'شاشات',
    badge: 'جديد',
    customFields: []
  },
  {
    ...
    desc: 'تصوير واضح ومناسبة للواجهات والمداخل.',
    price: 249,
    oldPrice: null,
    image: 'image/new products/new 8.jpg',
    category: 'cameras',
    catLabel: 'كاميرات',
    badge: 'جديد',
    customFields: []
  },
  {
    ...
    desc: 'شحن آمن وسريع لعدة أجهزة في وقت واحد.',
    price: 119,
    oldPrice: null,
    image: 'image/new products/new 9.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'جديد',
    customFields: []
  },
  {
    ...
    desc: 'متابعة النشاط والتنبيهات اليومية بتصميم أنيق.',
    price: 229,
    oldPrice: null,
    image: 'image/new products/new 10.jpg',
    category: 'devices',
    catLabel: 'أجهزة ذكية',
    badge: 'جديد',
    customFields: []
...
const WEEK_PRODUCTS = [
  {
    id: 301,
    name: 'حقيبة سفر ذكية',
    desc: 'تصميم عملي ومساحة مناسبة للتنقل والسفر اليومي.',
    price: 329,
    oldPrice: 399,
    image: 'image/week/w1.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'الأكثر طلباً',
    customFields: []
  },
  {
    ...
    desc: 'تثبيت قوي وسهل الاستخدام أثناء القيادة.',
    price: 69,
    oldPrice: null,
    image: 'image/week/w2.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'الأكثر طلباً',
    customFields: []
  ...
  {
    id: 303,
    name: 'شاحن جداري سريع',
    desc: 'يدعم الشحن السريع مع حماية للأجهزة المتعددة.',
    price: 89,
    oldPrice: 119,
    image: 'image/week/w3.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'الأكثر طلباً',
    customFields: []
  ...
  {
    id: 304,
    name: 'كيبل شحن Type-C',
    desc: 'كيبل متين للشحن ونقل البيانات بسرعة ثابتة.',
    price: 39,
    oldPrice: null,
    image: 'image/week/w4.jpg',
    category: 'cables',
    catLabel: 'أسلاك وكيابل',
    badge: 'الأكثر طلباً',
    customFields: []
  },
  {
    id: 305,
    name: 'سماعة لاسلكية مدمجة',
    desc: 'صوت واضح وتصميم خفيف للاستخدام اليومي.',
    price: 149,
    oldPrice: 189,
    image: 'image/week/w5.jpg',
    category: 'audio',
    catLabel: 'صوتيات',
    badge: 'الأكثر طلباً',
    customFields: []
  },
  {
    ...
    desc: 'رؤية واضحة ومتابعة سهلة عبر الجوال.',
    price: 199,
    oldPrice: null,
    image: 'image/week/w6.jpg',
    category: 'cameras',
    catLabel: 'كاميرات',
    badge: 'الأكثر طلباً',
    customFields: []
  },
  {
    ...
    desc: 'صوت قوي وبطارية مناسبة للرحلات والاستخدام الخارجي.',
    price: 229,
    oldPrice: 279,
    image: 'image/week/w7.jpg',
    category: 'audio',
    catLabel: 'صوتيات',
    badge: 'الأكثر طلباً',
    customFields: []
  },
  {
    ...
    desc: 'تتبع النشاط والتنبيهات مع تصميم رسمي أنيق.',
    price: 249,
    oldPrice: null,
    image: 'image/week/w8.jpg',
    category: 'devices',
    catLabel: 'أجهزة ذكية',
    badge: 'الأكثر طلباً',
    customFields: []
  ...
  {
    id: 309,
    name: 'محول منافذ USB-C',
    desc: 'حل عملي لتوصيل الأجهزة والشاشات والملحقات.',
    price: 129,
    oldPrice: null,
    image: 'image/week/w9.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'الأكثر طلباً',
    customFields: []
  ...
  {
    id: 310,
    name: 'باور بنك سريع الشحن',
    desc: 'سعة مناسبة وشحن سريع للأجهزة أثناء التنقل.',
    price: 179,
    oldPrice: 219,
    image: 'image/week/w10.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'الأكثر طلباً',
    customFields: []
...
const OFFERS_PRODUCTS = [
  {
    id: 401,
    name: 'باقة حماية المنزل الذكية',
    desc: 'مجموعة عملية للمتابعة والحماية اليومية بسعر موفر.',
    price: 299,
    oldPrice: 399,
    image: 'image/offers products/offer 1.jpg',
    category: 'security',
    catLabel: 'أنظمة أمنية',
    badge: 'عرض خاص',
    customFields: []
  },
  {
    id: 402,
    name: 'كاميرا مراقبة عالية الوضوح',
    desc: 'تصوير واضح ومناسب للمنزل والمكتب ضمن عرض محدود.',
    price: 179,
    oldPrice: 239,
    image: 'image/offers products/offer 2.jpg',
    category: 'cameras',
    catLabel: 'كاميرات',
    badge: 'عرض خاص',
    customFields: []
  ...
  {
    id: 403,
    name: 'شاشة عرض مكتبية',
    desc: 'شاشة أنيقة للعمل اليومي وتجربة مشاهدة مريحة.',
    price: 449,
    oldPrice: 549,
    image: 'image/offers products/offer 3.jpg',
    category: 'screens',
    catLabel: 'شاشات',
    badge: 'عرض خاص',
    customFields: []
  ...
  {
    id: 404,
    name: 'طقم أسلاك وكيابل',
    desc: 'مجموعة كيابل أساسية للشحن والتوصيل بسعر اقتصادي.',
    price: 69,
    oldPrice: 99,
    image: 'image/offers products/offer 4.jpg',
    category: 'cables',
    catLabel: 'أسلاك وكيابل',
    badge: 'عرض خاص',
    customFields: []
  },
  {
    id: 405,
    name: 'سماعة بلوتوث محمولة',
    desc: 'صوت واضح وحجم مناسب للتنقل والاستخدام اليومي.',
    price: 129,
    oldPrice: 169,
    image: 'image/offers products/offer 5.jpg',
    category: 'audio',
    catLabel: 'صوتيات',
    badge: 'عرض خاص',
    customFields: []
  ...
  {
    id: 406,
    name: 'ملحقات جوال موفرة',
    desc: 'اختيار عملي من ملحقات الجوال الأكثر استخداماً.',
    price: 59,
    oldPrice: 89,
    image: 'image/offers products/offers 6.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'عرض خاص',
    customFields: []
  ...
  {
    id: 407,
    name: 'جهاز ذكي للمنزل',
    desc: 'حل تقني بسيط لتحسين تجربة المنزل الذكي.',
    price: 219,
    oldPrice: 289,
    image: 'image/offers products/offer7.jpg',
    category: 'devices',
    catLabel: 'أجهزة ذكية',
    badge: 'عرض خاص',
    customFields: []
  ...
  {
    id: 408,
    name: 'كاميرا داخلية بسعر موفر',
    desc: 'متابعة واضحة ومناسبة للغرف والمكاتب الصغيرة.',
    price: 149,
    oldPrice: 199,
    image: 'image/offers products/offer 8.jpg',
    category: 'cameras',
    catLabel: 'كاميرات',
    badge: 'عرض خاص',
    customFields: []
  ...
  {
    id: 409,
    name: 'محول منافذ متعدد',
    desc: 'حل سريع لتوصيل الأجهزة والشاشات والملحقات.',
    price: 99,
    oldPrice: 139,
    image: 'image/offers products/offer 9.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'عرض خاص',
    customFields: []
  },
  {
    id: 410,
    name: 'باور بنك سريع الشحن',
    desc: 'طاقة إضافية موثوقة للأجهزة أثناء التنقل.',
    price: 159,
    oldPrice: 219,
    image: 'image/offers products/offer 10.jpg',
    category: 'accessories',
    catLabel: 'إكسسوارات',
    badge: 'عرض خاص',
    customFields: []
...
const CATEGORIES = [
  { key: 'all', label: 'الكل' },
  { key: 'giveaways', label: 'هدايا دعائية' },
  { key: 'car-hangers', label: 'معلقات سيارات' },
  { key: 'stickers', label: 'ستيكرات أجهزة' },
  { key: 'laser', label: 'حفر بالليزر' },
  { key: 'occasions', label: 'مناسبات' },
  { key: 'custom', label: 'طلبات خاصة' }
];

const WA_NUMBER = '967784449090';
...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
function initRacCategoryStrip() {
  const track = document.getElementById('racCategoriesTrack');
  const prevBtn = document.getElementById('racCategoryPrev');
  const nextBtn = document.getElementById('racCategoryNext');
  if (!track || !prevBtn || !nextBtn) return;

  const isRtl = getComputedStyle(track).direction === 'rtl';
  const step = () => Math.max(220, Math.round(track.clientWidth * 0.65));

  function getLimits() {
    const maxScroll = Math.max(0, track.scrollWidth - track.clientWidth);
    return isRtl ? { min: -maxScroll, max: 0 } : { min: 0, max: maxScroll };
  }

  function updateButtons() {
    const { min, max } = getLimits();
    const current = track.scrollLeft;
    const noOverflow = Math.abs(max - min) <= 1;
    ...
    prevBtn.disabled = current <= min + 2;
    nextBtn.disabled = current >= max - 2;
  }
  ...
  window.addEventListener('resize', () => requestAnimationFrame(updateButtons), { passive: true });
...
function initHorizontalControls(track, prevBtn, nextBtn) {
  if (!track || !prevBtn || !nextBtn) return;
...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
function buildFeaturedProductCardHTML(p) {
  const badgeMap = {
    'الأكثر مبيعاً': 'best',
    'الأكثر طلباً': 'week',
    'جديد': 'new',
  ...
  const badgeClass = badgeMap[p.badge] || 'default';
  const badgeHTML = p.badge ? `<span class="featured-product-badge featured-product-badge--${badgeClass}">${p.badge}</span>` : '';
  const oldPriceHTML = p.oldPrice ? `<span class="featured-product-old-price">${p.oldPrice} ${SAR_SVG}</span>` : '';
  return `
    <article class="featured-product-card" data-product-id="${p.id}">
      <div class="featured-product-image">
        ...
        ${badgeHTML}
        <button class="featured-fav-btn" type="button" onclick="event.preventDefault(); event.stopPropagation();" aria-label="إضافة للمفضلة">
        ...
        <button class="featured-add-btn" type="button" onclick="event.preventDefault(); event.stopPropagation(); handleAddToCart(${p.id}, this)" aria-label="إضافة للسلة">
      ...
      <div class="featured-product-info">
        ...
        <div class="featured-product-price-row">
          ${oldPriceHTML}
          <strong class="featured-product-price">${p.price} ${SAR_SVG}</strong>
        </div>
      </div>
    </article>`;
}
...
function renderBestsellers() {
  ...
  if (!container) return;
  container.innerHTML = FEATURED_PRODUCTS.map((p) => buildFeaturedProductCardHTML(p)).join('');
  initHorizontalControls(container, document.getElementById('featuredPrev'), document.getElementById('featuredNext'));
  container.querySelectorAll('.featured-fav-btn').forEach((btn) => {
...
function renderNewProducts() {
  ...
  if (!container) return;
  container.innerHTML = NEW_PRODUCTS.map((p) => buildFeaturedProductCardHTML(p)).join('');
  initHorizontalControls(container, document.getElementById('newProductsPrev'), document.getElementById('newProductsNext'));
  container.querySelectorAll('.featured-fav-btn').forEach((btn) => {
    btn.addEventListener('click', () => btn.classList.toggle('active'));
  });
}

function renderWeekProducts() {
  const container = document.getElementById('weekProductsSlider');
  if (!container) return;
  container.innerHTML = WEEK_PRODUCTS.map((p) => buildFeaturedProductCardHTML(p)).join('');
  initHorizontalControls(container, document.getElementById('weekProductsPrev'), document.getElementById('weekProductsNext'));
  container.querySelectorAll('.featured-fav-btn').forEach((btn) => {
    btn.addEventListener('click', () => btn.classList.toggle('active'));
  });
}
...
function renderOffersProducts() {
  const container = document.getElementById('offersProductsSlider');
  if (!container) return;
  container.innerHTML = OFFERS_PRODUCTS.map((p) => buildFeaturedProductCardHTML(p)).join('');
  initHorizontalControls(container, document.getElementById('offersProductsPrev'), document.getElementById('offersProductsNext'));
  container.querySelectorAll('.featured-fav-btn').forEach((btn) => {
    btn.addEventListener('click', () => btn.classList.toggle('active'));
  });
}
...
function handleAddToCart(productId, btnEl) {
  const product = [...PRODUCTS, ...FEATURED_PRODUCTS, ...NEW_PRODUCTS, ...WEEK_PRODUCTS, ...OFFERS_PRODUCTS].find(p => p.id === productId);
  if (!product) return;
...
function saveCart() { localStorage.setItem('alamah_cart', JSON.stringify(cart)); }

function flashButton(btn) {
  if (!btn) return;
  const isFeaturedAdd = btn.classList.contains('featured-add-btn');
  btn.classList.add('added');
  btn.innerHTML = isFeaturedAdd
  ...
  // Bounce badge
  document.querySelectorAll('.cart-badge').forEach(b => { b.classList.add('bounce'); setTimeout(() => b.classList.remove('bounce'), 500); });
}
  ...
  if (!product) {
    container.innerHTML = `
      <div class="col-12 text-center" style="padding:4rem 0;">
        ...
        <a href="products.html" class="btn-product-order" style="display:inline-block;margin-top:1rem;text-decoration:none;">تصفح المنتجات</a>
      </div>`;
    return;
  }

  // Update page title and breadcrumb
  document.title = `${product.name} | RAC`;
...
function initNewsletterForm() {
  ...
  const button = form.querySelector('.footer-newsletter-btn');
  const initialText = button?.textContent || 'اشتراك';
